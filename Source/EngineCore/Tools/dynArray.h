...
* dynArray.h
*
* Defines a dynamically allocated array template class. The functioning of this class is similar to std::vector in terms of usage
*  The definition of it is DynArray<Class> a;
**/

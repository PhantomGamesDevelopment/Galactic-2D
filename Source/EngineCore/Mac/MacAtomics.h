...
* MacAtomics.h
*
* Defines the PlatformAtomics class for mac platforms
*
* References:
* https://mikeash.com/pyblog/friday-qa-2011-03-04-a-tour-of-osatomic.html
**/

#ifndef GALACTIC_PLATFORM_MAC_PLATFORMATOMICS
#define GALACTIC_PLATFORM_MAC_PLATFORMATOMICS
...
namespace Galactic {
	...
	namespace Core {
		...
		/*
		PlatformAtomics: Defines atomic locking capabilties for Mac platforms.
		*/
...
#endif //GALACTIC_PLATFORM_MAC_PLATFORMATOMICS
...
namespace Galactic {
	...
	namespace Core {
		 ...
		 */
		template <typename returnType, typename... parameters> class DelegateBase;
		 ...
		 */
		template <typename returnType, typename... parameters> class StaticDelegate : public DelegateBase<returnType, parameters...> {
			public:
				...
				template <typename classType> using MemberDelegateFuncPtr = returnType(classType::*)(parameters...);
				 ...
				 */
				StaticDelegate(const StaticDelegate<returnType, parameters...>& other) : DelegateBase<returnType, parameters...>(false), mProcAddress(other.mProcAddress) { }
		 ...
		 */
		template <typename classType, typename returnType, typename... parameters> class MemberDelegate : public DelegateBase<returnType, parameters...> {
			public:
				//! Helper typedef referring to a member function pointer.
				 ...
				 */
				MemberDelegate(classType *thisPtr, MemberDelegateFuncPtr procAddress) : mThisPtr(thisPtr), mProcAddress(procAddress), DelegateBase<returnType, parameters...>(true) { }

				/**
				 *  @brief Standard copy constructor.
				 */
				MemberDelegate(const MemberDelegate<classType, returnType, parameters...>& other) : mThisPtr(other.mThisPtr), mProcAddress(other.mProcAddress), DelegateBase<returnType, parameters...>(true) { }
		 ...
		 */
		template <typename returnType, typename... parameters> class DelegateSet {
			private:
		 ...
		 */
		template <typename returnType, typename... parameters> class DelegateBase : public GenericDelegate {
			public:
				...
				template <typename classType> using MemberDelegateType = MemberDelegate<classType, returnType, parameters...>;
				 ...
				 */
				template <typename className> bool has_procaddress(DelegateBase::MemberDelegateFuncPtr<className> procAddress) noexcept {
